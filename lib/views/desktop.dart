...
class NumeracionTantricaDesktop extends StatefulWidget {
  const NumeracionTantricaDesktop({super.key});

  @override
  _NumeracionTantricaDesktopState createState() =>
      _NumeracionTantricaDesktopState();
}

class _NumeracionTantricaDesktopState extends State<NumeracionTantricaDesktop> {
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    //sumDateDigits()
                    Text(
                      // 'Mision de vida: ${calculateCenterValue()}',
                      'VIDA: ${sumDateDigits()}',
                      style:
