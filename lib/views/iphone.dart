...
class NumeracionTantricaIphone extends StatefulWidget {
  const NumeracionTantricaIphone({super.key});

  @override
  _NumeracionTantricaIphoneState createState() =>
      _NumeracionTantricaIphoneState();
}

class _NumeracionTantricaIphoneState extends State<NumeracionTantricaIphone> {
